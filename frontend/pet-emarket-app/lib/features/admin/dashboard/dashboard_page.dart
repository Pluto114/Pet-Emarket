...
class _DashboardPageState extends State<DashboardPage> {
      ...
      child: ListView(
        ...
        children: [
              ...
              return Wrap(
                ...
                children: [
                  ...
                  _StatCard(
                    ...
                    label: '在售商品',
                    value: (data?.onSaleProductCount ?? 0).toString(),
                  ...
                  _StatCard(
                    ...
                    label: '待处理退款',
                    value: (data?.refundPendingCount ?? 0).toString(),
                  ...
                  _StatCard(
                    icon: Icons.pets,
                    label: '待审核宠物',
                    value: (data?.pendingLivePetAuditCount ?? 0).toString(),
                  ...
                  _StatCard(
                    icon: Icons.store,
                    label: '营业店铺',
                    value: (data?.openStoreCount ?? 0).toString(),
              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    ...
                    const Spacer(),
                    Text(
                      '¥${data.totalPayAmount.toStringAsFixed(2)}',
          ...
          if (data != null && data.orderStatusDistribution.isNotEmpty) ...[
            ...
            Wrap(spacing: 16, runSpacing: 8, children: _buildLegend(theme)),
            const SizedBox(height: 28),
          ],
  ...
  List<PieChartSectionData> _buildPieSections(ThemeData theme) {
    final counts =
        dashboard?.orderStatusDistribution ?? const <OrderStatusCount>[];
    final colors = [
      const Color(0xFF204E4A),
      const Color(0xFF6FDA44),
      const Color(0xFFEC7357),
      const Color(0xFFE1E53F),
          ...
          child: Row(
            children: [
              Container(
                ...
                height: 48,
                decoration: BoxDecoration(
                  color: isLight ? color.withAlpha(20) : color.withAlpha(30),
