...
class _UserDialogState extends State<_UserDialog> {
  late final userCtrl = TextEditingController(
            ...
            children: [
              ...
              DropdownButtonFormField<String>(
                ...
                items: const [
                  ...
                  DropdownMenuItem(value: 'MERCHANT', child: Text('商家')),
                  DropdownMenuItem(value: 'CUSTOMER', child: Text('用户')),
                ],
              ...
              DropdownButtonFormField<String>(
                ...
                items: const [
                  ...
                  DropdownMenuItem(value: 'SVIP', child: Text('SVIP')),
                ],
      ...
      actions: [
        ...
        FilledButton(
          onPressed: () {
            ...
            if (widget.user == null) {
              payload['username'] = userCtrl.text.trim();
              payload['password'] = pwdCtrl.text;
            }
            if (widget.user != null && pwdCtrl.text.isNotEmpty)
              payload['password'] = pwdCtrl.text;
