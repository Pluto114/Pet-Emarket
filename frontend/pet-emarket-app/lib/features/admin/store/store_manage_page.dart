    ...
    return RefreshIndicator(
      ...
      child: ListView(
        ...
        children: [
          Row(
            children: [
              Expanded(child: Text('店铺管理', style: theme.textTheme.headlineSmall?.copyWith(fontWeight: FontWeight.w700))),
              FilledButton.icon(onPressed: () => _showDialog(), icon: const Icon(Icons.add), label: const Text('添加店铺')),
            ],
          ),
...
class _StoreDialogState extends State<_StoreDialog> {
  ...
  late final districtCtrl = TextEditingController(text: widget.store?.district ?? '西湖区');
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              TextField(controller: addressCtrl, decoration: const InputDecoration(labelText: '详细地址')),
              const SizedBox(height: 10),
              Row(
                children: [
              ...
              Row(
                children: [
                  Expanded(child: TextField(controller: ratingCtrl, decoration: const InputDecoration(labelText: '评分'), keyboardType: TextInputType.number)),
                  const SizedBox(width: 10),
                  Expanded(
              ...
              const SizedBox(height: 10),
              TextField(controller: tagsCtrl, decoration: const InputDecoration(labelText: '特色标签')),
            ],
          ),
        ),
      ),
