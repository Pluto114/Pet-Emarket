                ...
                child: Center(
                  child: Chip(
                    avatar: CircleAvatar(
                      ...
                      child: Text(
                        (widget.sessionStore.user?.displayName ?? 'A')
                                .isNotEmpty
                            ? widget.sessionStore.user!.displayName[0]
                                .toUpperCase()
                            : 'A',
                        style: TextStyle(
                          fontSize: 11,
                    ...
                    label: Text(
                      widget.sessionStore.user?.displayName ?? 'Admin',
                        ...
                        DrawerHeader(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                widget.sessionStore.user?.displayName ??
                                    'Admin',
